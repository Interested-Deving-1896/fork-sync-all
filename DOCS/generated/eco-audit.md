...
> Generated 2026-06-24 by `scripts/eco/eco-audit.sh`
...
| ✅ concurrency groups | 2/2 | Concurrency groups: 128/137 workflows (93%) |
...
|---|---|
| Total workflows | 137 |
| Workflows with concurrency groups | 128 (93%) |
| Scripts using GraphQL | 33 |
| apt-get install calls | 8 |
