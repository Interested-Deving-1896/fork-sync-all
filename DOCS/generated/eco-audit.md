...
> Generated 2026-09-10 by `scripts/eco/eco-audit.sh`
...
| ✅ concurrency groups | 2/2 | Concurrency groups: 163/180 workflows (90%) |
...
|---|---|
| Total workflows | 180 |
| Workflows with concurrency groups | 163 (90%) |
