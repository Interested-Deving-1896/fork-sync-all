...
> Generated 2026-09-25 by `scripts/eco/eco-audit.sh`
...
| ✅ concurrency groups | 2/2 | Concurrency groups: 164/180 workflows (91%) |
...
|---|---|
| Total workflows | 180 |
| Workflows with concurrency groups | 164 (91%) |
