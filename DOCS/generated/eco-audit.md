...
> Generated 2026-06-21 by `scripts/eco/eco-audit.sh`
...
| ✅ concurrency groups | 2/2 | Concurrency groups: 124/127 workflows (97%) |
...
|---|---|
| Total workflows | 127 |
| Workflows with concurrency groups | 124 (97%) |
